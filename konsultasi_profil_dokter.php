            ...
            <div class="flex flex-row gap-14 max-w-5xl h-full">
                <div>
                    <div class="flex flex-col">
                        <div class="h-36 w-36 bg-gray-300 rounded-full"></div>
                        <div class="mt-3 font-medium">dr. Dwi Hari Susilo</div>
                    </div>
                </div>
                <div class="h-full">
                    <div class="flex flex-col h-full">
                        <div>
                            <div class="flex flex-row">
                                <div class="bg-gray-100 px-10 py-3 ml-10 font-medium rounded-t-2xl">Profil</div>
                                <div class="bg-gray-50 px-10 py-3 ml-3 font-medium rounded-t-2xl text-gray-400">Kontak</div>
                            </div>
                        </div>
