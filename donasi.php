        ...
        <div class="grid grid-cols-2 w-full px-6 max-w-6xl gap-6 mt-10">
            <div>
                <div class="bg-red-200 w-full rounded-2xl p-6">
                    <div class="flex flex-row">
                        <div>
                            <div class="w-14 h-14 bg-gray-400 rounded-2xl mr-5"></div>
                        </div>
                        <div class="flex flex-col flex-grow">
                            <b class="text-xl">Bandu Deni Lawan Kanker Usus</b>
                            <p>Deni adalah anak berusia 10 tahun yang kini sedang menderita kanker usus dan sulit mendapatkan biaya pengobatan. Yuk bantu Deni?</p>
                        </div>
                    </div>
                    <div class="grid justify-items-end">
                        <a href="" class="text-blue-400">Lihat Detil ></a>
                    </div>
                </div>
            </div>
            <div>
