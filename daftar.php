            ...
            <div class="bg-red-100 shadow-lg overflow-hidden max-w-lg rounded-2xl self-center p-10">
                <form action="" method="post">
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <input type="date" name="kota" class="py-2 px-5 rounded-3xl placeholder-red-500 w-96" placeholder="Tanggal lahir kamu">
                        ...
                        <input type="submit" value="Daftar" class="py-2 px-5 rounded-3xl bg-red-400 text-white font-bold">
                    </div>
                </form>
            </div>
